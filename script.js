let input = document.createElement('input'); //Created input element
...
let butonclr = document.createElement('button');//Created button element
...
let butonback = document.createElement('button');//Created button element
...
let butondis1 = document.createElement('button');//Created button element
...
let butondis2 = document.createElement('button');//Created button element
...
let butondis3 = document.createElement('button');//Created button element
...
let butondis4 = document.createElement('button');//Created button element
...
let butondis5 = document.createElement('button');//Created button element
...
let butondis6 = document.createElement('button');//Created button element
...
let butondis7 = document.createElement('button');//Created button element
...
let butondis8 = document.createElement('button');//Created button element
...
let butondis9 = document.createElement('button');//Created button element
...
let butondis10 = document.createElement('button');//Created button element
...
let butondis11 = document.createElement('button');//Created button element
...
let butondis12 = document.createElement('button');//Created button element
...
let butondis13 = document.createElement('button');//Created button element
...
let butondis14 = document.createElement('button');//Created button element
...
let butondis15 = document.createElement('button');//Created button element
...
let butondis16 = document.createElement('button');//Created button element
...
let butondis17 = document.createElement('button');//Created button element
...
let outputScreen = document.getElementById("textinput"); //get element by id of input element

outputScreen.addEventListener('onclick',display);//Added a eventlistner to call functions


function display(num){//fuction to display on the input field
    outputScreen.value += num; 
      
}

function Calculate(){//fuction to calculate
    try{
        outputScreen.value = eval(outputScreen.value);//eval math function is used to evaluate the string.
    }catch(err){
        alert("Only numbers are allowed")//alert if wrong numbers is entered
    }
}

function Clear(){//fuction to clear field
    outputScreen.value = '';
}

function del(){//fuction to deleter one value in the field
